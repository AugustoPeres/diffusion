"""File with equinox models.

I take no credit for this.
All credit to: Ben Walker (https://github.com/Benjamin-Walker)
...
class ResnetBlock(eqx.Module):
    ...
    block2_layers: list[Union[eqx.nn.GroupNorm, eqx.nn.Dropout, eqx.nn.Conv2d,
                              Callable]]
    ...
    def __init__(
        ...
        *,
        ...
        self.block1_conv = eqx.nn.Conv2d(dim_in,
                                         dim_out,
                                         3,
                                         padding=1,
                                         key=keys[1])
        ...
        self.res_conv = eqx.nn.Conv2d(dim_in,
                                      dim_out,
                                      kernel_size=1,
                                      key=keys[5])
...
class UNet(eqx.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.first_conv = eqx.nn.Conv2d(data_channels,
                                        hidden_size,
                                        kernel_size=3,
                                        padding=1,
                                        key=keys[1])
        ...
        for res_blocks in self.ups_res_blocks:
            for res_block in res_blocks:
                ...
                if res_block.up:
                    ...
                    h = res_block(jnp.concatenate((h, hs.pop()), axis=0),
                                  t,
                                  key=subkey)
